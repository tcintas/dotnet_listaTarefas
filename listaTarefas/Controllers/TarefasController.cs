...
namespace listaTarefas.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TarefasId,Nome,Descricao,Inicio,Importancia")] Tarefas tarefas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarefasId,Nome,Descricao,Inicio,Importancia")] Tarefas tarefas)
        {
